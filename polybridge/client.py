...
class PolybridgeClient:
    ...
    def fetch_nested_timeseries(
        ...
        *,
        ...
        """Fetch nested timeseries data with hierarchical structure.

        Returns data in a nested format with records organized by timestamp.
        ...
        asset : str
            Asset symbol (e.g., "BTC", "ETH")
        horizon : str
            Market horizon (e.g., "daily", "weekly")
        market_types : Optional[Sequence[str]]
        ...
        end_ts : Optional[str]
            End timestamp in ISO 8601 format
        hours : float
            Hours of data if timestamps not provided (default: 6.0)
        include_spot : bool
            Include spot prices (default: True)
        include_perp : bool
            Include perpetual prices (default: False)
        include_open_interest : bool
            Include open interest (default: True)
        include_funding : bool
            Include funding rates (default: False)

        Returns
        -------
        Dict[str, object]
            Response with "records" (list) and "meta" (dict)
        """
        payload: Dict[str, object] = {
            "asset": asset,
            "horizon": horizon,
        ...
        return self._post("api_v1_timeseries", payload)
